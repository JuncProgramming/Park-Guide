...
object DataSource {
    ...
    private val americanSamoaParks = listOf(
        Park(
            ...
            description = R.string.National_Park_of_American_Samoa,
    ...
    private val arizonaParks = listOf(
        Park(
            ...
            description = R.string.Petrified_Forest_National_Park,
            image = R.drawable.petrifiedforestnationalpark
        ), Park(
            title = R.string.Saguaro_National_Park,
            description = R.string.Saguaro_National_Park,
    ...
    private val arkansasParks = listOf(
        Park(
            ...
            description = R.string.Hot_Springs_National_Park,
    ...
    private val hawaiiParks = listOf(
        Park(
            ...
            description = R.string.Haleakalā_National_Park,
            image = R.drawable.haleakalnationalpark
        ), Park(
            title = R.string.Hawaii_Volcanoes_National_Park,
            description = R.string.Hawaii_Volcanoes_National_Park,
    ...
    private val idahoParks = listOf(
        Park(
            ...
            description = R.string.Yellowstone_National_Park,
    ...
    private val indianaParks = listOf(
        Park(
            ...
            description = R.string.Indiana_Dunes_National_Park,
    ...
    private val maineParks = listOf(
        Park(
            ...
            description = R.string.Acadia_National_Park,
    ...
    private val michiganParks = listOf(
        Park(
            ...
            description = R.string.Isle_Royale_National_Park,
    ...
    private val minnesotaParks = listOf(
        Park(
            ...
            description = R.string.Voyageurs_National_Park,
    ...
    private val missouriParks = listOf(
        Park(
            ...
            description = R.string.Gateway_Arch_National_Park,
    ...
    private val nevadaParks = listOf(
        ...
        Park(
            ...
            description = R.string.Great_Basin_National_Park,
    ...
    private val newMexicoParks = listOf(
        Park(
            ...
            description = R.string.Carlsbad_Caverns_National_Park,
            image = R.drawable.carlsbadcavernsnationalpark
        ),
        Park(
            title = R.string.White_Sands_National_Park,
            description = R.string.White_Sands_National_Park,
    ...
    private val northCarolinaParks = listOf(
        Park(
            ...
            description = R.string.Great_Smoky_Mountains_National_Park,
    ...
    private val northDakotaParks = listOf(
        Park(
            ...
            description = R.string.Theodore_Roosevelt_National_Park,
    ...
    private val ohioParks = listOf(
        Park(
            ...
            description = R.string.Cuyahoga_Valley_National_Park,
    ...
    private val oregonParks = listOf(
        Park(
            ...
            description = R.string.Crater_Lake_National_Park,
    ...
    private val southCarolinaParks = listOf(
        Park(
            ...
            description = R.string.Congaree_National_Park,
    ...
    private val southDakotaParks = listOf(
        Park(
            ...
            description = R.string.Badlands_National_Park,
            image = R.drawable.badlandsnationalpark
        ),
        Park(
            title = R.string.Wind_Cave_National_Park,
            description = R.string.Wind_Cave_National_Park,
    ...
    private val texasParks = listOf(
        Park(
            ...
            description = R.string.Big_Bend_National_Park,
            image = R.drawable.bigbendnationalpark
        ),
        Park(
            title = R.string.Guadalupe_Mountains_National_Park,
            description = R.string.Guadalupe_Mountains_National_Park,
    ...
    private val VirginIslandsPark = listOf(
        Park(
            ...
            description = R.string.Virgin_Islands_National_Park,
    ...
    private val virginiaParks = listOf(
        Park(
            ...
            description = R.string.Shenandoah_National_Park,
    ...
    private val washingtonParks = listOf(
        Park(
            ...
            description = R.string.Mount_Rainier_National_Park,
            image = R.drawable.mountrainiernationalpark
        ),
        Park(
            title = R.string.North_Cascades_National_Park,
            description = R.string.North_Cascades_National_Park,
    ...
    private val westVirginiaParks = listOf(
        Park(
            ...
            description = R.string.New_River_Gorge_National_Park_and_Preserve,
